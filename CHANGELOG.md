...
### Fixed
- Update `easyathome-ble` dependency to `0.2.4` to support environments pinned to `bleak` 3.x
...
[0.1.6]: https://github.com/chmielowiec/hass-easyathome/releases/tag/v0.1.6
