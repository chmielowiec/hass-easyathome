"""Config flow for Easy@Home integration."""
...
class EasyHomeConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for Easy@Home."""
    ...
    async def async_step_bluetooth(
        ...
        self.context["title_placeholders"] = {"name": get_title(discovery_info)}
    ...
    async def async_step_bluetooth_confirm(
        ...
        if user_input is not None:
            ...
            return self.async_create_entry(
                ...
                data={CONF_ADDRESS: discovery.discovery_info.address},
            )
        ...
        return self.async_show_form(
            ...
            description_placeholders={
                "name": get_title(self._discovered_devices[self.unique_id].discovery_info)
            },
        )
